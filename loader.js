...
/*
can't get this part to load when bypassing XHR
	let dom = new File([], "file:///C:/Users/Dusty/Documents/gitrepos/ping-pong/index.html");
*/
...
if (typeof console !== 'undefined' && console.log) {
	...
	*/
	...
	var sendRequest = function(instrumentId, audioFormat, onprogress, onsuccess, onerror) {
		...
		if (root.USE_XHR) {
			// why is "request" undefined here while local server is active?
			root.util.request({
				url: soundfontPath,
				format: 'text',
				onerror: onerror,
